          ...
          return (
            <Link
              ...
              <div className='flex items-start justify-between'>
                ...
                <div
                  className={`p-3 rounded-xl bg-linear-to-r ${card.color} opacity-80 group-hover:opacity-100 transition-opacity`}>
                  <Icon className='w-6 h-6 text-white' />
                </div>
              </div>
              <div
                className={`absolute inset-0 bg-linear-to-r ${card.color} opacity-0 group-hover:opacity-5 transition-opacity`}
              />
            </Link>
          );
        })}
