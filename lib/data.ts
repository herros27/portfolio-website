...
export const projectsData = [
  {
    ...
    // ✅ Gunakan String Path (Pastikan nama file persis besar/kecilnya)
  ...
  },
  {
    ...
    description: "Website profile for PT. KOMPAL SARANA...",
...
export const certificatesData = [
  ...
  },
  {
    ...
    description: "Awarded as one of the Top 50...",
    tags: ["Product Management"],
    imageUrl: "/achievement.png",
  },
  {
    title: "Certificate of Completion IDCamp (Flutter)",
    description: "Completed the Expert-level...",
    tags: ["Flutter", "Dart"],
    imageUrl: "/idcamp.png",
  }
] as const;
