    ...
    <section
      ...
      <div className='absolute inset-y-0 left-1/2 -translate-x-1/2 w-screen pointer-events-none z-10 overflow-hidden'>
        <motion.div
          ...
          className='absolute top-0 left-1/4 w-96 h-96 bg-amber-500/5 dark:bg-amber-500/10 rounded-full blur-3xl'
        />
        <motion.div
          animate={{
            scale: [1, 1.2, 1],
          ...
          className='absolute bottom-0 right-1/4 w-96 h-96 bg-orange-500/5 dark:bg-orange-500/10 rounded-full blur-3xl'
        />
        <motion.div
          animate={{
            scale: [1, 1.15, 1],
          ...
          className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-yellow-500/3 dark:bg-yellow-500/5 rounded-full blur-3xl'
        />
      </div>
