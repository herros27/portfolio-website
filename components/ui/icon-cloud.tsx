  ...
  return (
    <div ref={inViewRef}>
      <canvas
        ...
        className='hover:scale-140 transition-transform duration-300 ease-out rounded-full cursor-grab active:cursor-grabbing hover:shadow-lg hover:shadow-cyan-500/10 dark:invert'
