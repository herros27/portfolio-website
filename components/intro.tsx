...
const [images, setImages] = useState<string[]>([]);
  ...
  useEffect(() => {
    fetch("https://api.unsplash.com/photos/random?count=30&client_id=Vke3mS727zZ9UUD-1q35lIOjX4y29RM4hShA1BFVZGE")
      .then(res => res.json())
      .then(data => {
  ...
  >
    ...
    <div className="relative z-20 mx-auto max-w-[50rem]">
      ...
      >
        ...
        <a
          className="borderBlack group flex cursor-pointer items-center gap-2 rounded-full bg-white px-7 py-3 outline-none transition focus:scale-110 hover:scale-110 active:scale-105 dark:bg-white/10"
          href="/CV.pdf"
          download
